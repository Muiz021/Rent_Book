                ...
                <div class="sidebar col-lg-2 collapse d-lg-block" id="sidebar">
                    @if (Auth::user())
                        @if (Auth::user()->role_id == 1)
                            ...
                            <a href="/books" @if (request()->route()->uri == 'books' || request()->route()->uri == 'book-add' || request()->route()->uri == 'book-deleted' || request()->route()->uri == 'book-edit/{slug}') class="active" @endif>Books</a>
                            ...
                            <a href="/users" @if (request()->route()->uri == 'users' || request()->route()->uri == 'registered-users' || request()->route()->uri == 'user-deleted' || request()->route()->uri == 'user-detail/{slug}') class="active" @endif>Users</a>
